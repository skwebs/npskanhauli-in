...
const Hero = () => {
  return (
    <section className="relative min-h-[75vh] lg:min-h-[85vh] flex items-center overflow-hidden bg-primary pt-32 md:pt-40 lg:pt-48 pb-20 md:pb-28 lg:pb-36">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col gap-3 md:gap-4 mb-10 md:mb-14 animate-fade-in-up delay-100">
          ...
          <div className="relative mb-10 md:mb-14 max-w-2xl animate-fade-in-up delay-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 animate-fade-in-up delay-300">
            <Button variant="accent" size="lg" href="/contact" className="text-base md:text-lg font-black px-8 md:px-12 py-5 md:py-7 rounded-xl shadow-xl shadow-accent/20 hover:scale-[1.02] transition-transform whitespace-nowrap">
              Admissions Open
            </Button>
            <Button variant="outline" size="lg" href="/about" className="text-base md:text-lg font-black border-white/30 text-white hover:bg-white hover:text-primary px-8 md:px-12 py-5 md:py-7 rounded-xl backdrop-blur-md whitespace-nowrap">
              Learn More
            </Button>
          </div>
        </div>
